...
describe('testing the tests: session parser function', () => {
  test('valid empty input string: no windows', async () => {
  ...
  test('valid input string: minimal: 1 window with 1 tab', async () => {
    // given an invalid input string
    const inputString = '[()]';
  ...
  test('valid input string: 1 window with 1 visible and 1 hidden tab', async () => {
    // given a valid input string
    const inputString = '[v(v,!v)]';
